...
public class week1_problem2 {
    public static int min_flips(int firstnum,int secnum,int result)
    {
        ...
        while(temp1!=max)
        {
            ...
            if(temp>result)
                temp1 = temp1 | x;                           // adding ech bit of maximum  to temp1 so that if both are equal we come out of loop
            else
                temp1 = temp1 |y;
